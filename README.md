...
and [`docs/features/TRACKER.md`](docs/features/TRACKER.md).
...
build or test**. → [`docs/guides/model-providers.md`](docs/guides/model-providers.md).

---

## Architecture

See **[`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md)** for the full overview (layer
...
- **[`CONTRIBUTING.md`](CONTRIBUTING.md)** — setup, the quality gate, the per-feature
...
| [`docs/guides/`](docs/guides/) | Consumer guides: [using over MCP](docs/guides/using-over-mcp.md), [model providers](docs/guides/model-providers.md), [storage backends](docs/guides/storage-backends.md) |
...
patent-retaliation clause. See [`LICENSE`](LICENSE) and [`NOTICE`](NOTICE). Aligns
