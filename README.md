...
| [`docs/guides/`](https://github.com/Scaffoldic/agentforge-grpah/tree/main/docs/guides/) | Consumer guides: [using over MCP](https://github.com/Scaffoldic/agentforge-grpah/blob/main/docs/guides/using-over-mcp.md), [model providers](https://github.com/Scaffoldic/agentforge-grpah/blob/main/docs/guides/model-providers.md), [storage backends](https://github.com/Scaffoldic/agentforge-grpah/blob/main/docs/guides/storage-backends.md) |
