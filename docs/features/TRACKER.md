...
| **W3** | **Remaining language packs** (feat-002 follow-ups) | Rust (Tier A) lands so the "10 languages" claim is real | 🔨 (9/10 shipped: Py/TS/JS/**Go**/**Ruby**/**PHP**/**Java**/**C#**/**C++**; cobra/thor/monolog/gson/njson/[fmt](../validation/cpp-fmt.md)) |
