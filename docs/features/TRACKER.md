...
| **W3** | **Remaining language packs** (feat-002 follow-ups) | Java, C#, Rust, Ruby, PHP (Tier A) + C++ (Tier B) land so the "10 languages" claim is real | 🔨 (4/10 shipped: Py/TS/JS/**Go**; [cobra run](../validation/go-cobra.md)) |
