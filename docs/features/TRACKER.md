...
| **W3** | **Remaining language packs** (feat-002 follow-ups) | C#, Rust (Tier A) + C++ (Tier B) land so the "10 languages" claim is real | 🔨 (7/10 shipped: Py/TS/JS/**Go**/**Ruby**/**PHP**/**Java**; [cobra](../validation/go-cobra.md), [thor](../validation/ruby-thor.md), [monolog](../validation/php-monolog.md), [gson](../validation/java-gson.md)) |
