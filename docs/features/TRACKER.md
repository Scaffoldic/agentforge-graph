...
| **W3** | **Remaining language packs** (feat-002 follow-ups) | Rust (Tier A) + C++ (Tier B) land so the "10 languages" claim is real | 🔨 (8/10 shipped: Py/TS/JS/**Go**/**Ruby**/**PHP**/**Java**/**C#**; cobra/thor/monolog/gson/[njson](../validation/csharp-newtonsoft-json.md)) |
