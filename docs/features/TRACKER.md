...
| **W3** | **Remaining language packs** (feat-002 follow-ups) | Java, C#, Rust, PHP (Tier A) + C++ (Tier B) land so the "10 languages" claim is real | 🔨 (5/10 shipped: Py/TS/JS/**Go**/**Ruby**; [cobra](../validation/go-cobra.md), [thor](../validation/ruby-thor.md)) |
