...
| **W3** | **Remaining language packs** (feat-002 follow-ups) | Java, C#, Rust (Tier A) + C++ (Tier B) land so the "10 languages" claim is real | 🔨 (6/10 shipped: Py/TS/JS/**Go**/**Ruby**/**PHP**; [cobra](../validation/go-cobra.md), [thor](../validation/ruby-thor.md), [monolog](../validation/php-monolog.md)) |
