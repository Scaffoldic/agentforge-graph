"""ADR-0001: the frameworks layer is deterministic engine code and must not
...
import agentforge_graph.frameworks as frameworks
...
def test_frameworks_does_not_import_agentforge() -> None:
    root = pathlib.Path(frameworks.__file__).parent
    offenders: list[str] = []
