"""ADR-0001: retrieve is deterministic engine code; it must not import the
...
import agentforge_graph.retrieve as retrieve
...
def test_retrieve_does_not_import_agentforge() -> None:
    root = pathlib.Path(retrieve.__file__).parent
    offenders: list[str] = []
