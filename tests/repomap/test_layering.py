"""ADR-0001: repomap is deterministic engine code; no AgentForge imports."""
...
import agentforge_graph.repomap as repomap
...
def test_repomap_does_not_import_agentforge() -> None:
    root = pathlib.Path(repomap.__file__).parent
    offenders: list[str] = []
